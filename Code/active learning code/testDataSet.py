...
trainIndices = np.array(random.sample(range(0,19996), 300))
...
print ("dumping svm")
joblib.dump(clf, 'newsBinSvm.pkl')
print ("svm dumped")

## loads the svm and computes accuracy
clf = joblib.load('newsBinSvm.pkl')
...
logit.fit(trainInstances, trainLabels)
accuracy = logit.score(testInstances, testLabels)
